...
container
  ...
  .inSingletonScope();
container
  .bind<ServerConfigService>(TYPES.ServerConfigService)
...
container
  ...
  .inSingletonScope();
container
  .bind<WebClientService>(TYPES.WebClientService)
  .to(WebClientService)
  .inSingletonScope();
container
  .bind<LogRequestService>(TYPES.LogRequestService)
  .to(LogRequestService)
  .inSingletonScope();

// Business Service
container.bind<LogTracker>(TYPES.LogTracker).to(LogTracker).inSingletonScope();
container
  .bind<IServerSetup>(TYPES.ServerSetupApache)
  .to(ApacheSetupServer)
  .inSingletonScope();
container.bind<SetupServers>(TYPES.Servers).to(SetupServers).inSingletonScope();
container
  .bind<UnInstallServer>(TYPES.UnInstallServer)
  .to(UnInstallServer)
  .inSingletonScope();
container
  .bind<IWebClientSetup>(TYPES.SetupWebClient)
  .to(SetupWebClient)
  .inSingletonScope();
container
  .bind<SetupWebClients>(TYPES.WebClients)
  .to(SetupWebClients)
  .inSingletonScope();
container
  .bind<IUniInstallSetup>(TYPES.ApacheUnInstallServer)
  .to(ApacheUnInstallServer)
  .inSingletonScope();
container
  .bind<IUnInstallWebClient>(TYPES.IUnInstallWebClient)
  .to(ApacheUnInstallWebClient)
  .inSingletonScope();
container
  .bind<UnInstallWebClients>(TYPES.UnInstallWebClients)
  .to(UnInstallWebClients)
  .inSingletonScope();
container
  .bind<IServerSetup>(TYPES.NginxSetupServer)
  .to(NginxSetupServer)
  .inSingletonScope();
container
  .bind<IWebClientSetup>(TYPES.NginxSetupWebClient)
  .to(NginxSetupWebClient)
  .inSingletonScope();
container
  .bind<IUnInstallWebClient>(TYPES.NginxUnInstallWebClient)
  .to(NginxUnInstallWebClient)
  .inSingletonScope();
container
  .bind<IUniInstallSetup>(TYPES.NginxUnInstallServer)
  .to(NginxUnInstallServer)
  .inSingletonScope();
...
container
  .bind<SetupServerWorker>(TYPES.SetupServerWorker)
  .to(SetupServerWorker)
  .inSingletonScope();
container
  .bind<SetupWebClientWorker>(TYPES.SetupWebClientWorker)
  .to(SetupWebClientWorker)
  .inSingletonScope();
container
  .bind<UnInstallServerWorker>(TYPES.UnInstallServerWorker)
  .to(UnInstallServerWorker)
  .inSingletonScope();
container
  .bind<UnInstallWebClientWorker>(TYPES.UnInstallWebClientWorker)
  .to(UnInstallWebClientWorker)
  .inSingletonScope();

//Commands
container
  .bind<WebClientCommand>(TYPES.WebClientCommand)
  .to(WebClientCommand)
  .inSingletonScope();
container
  .bind<WorkSpaceCommand>(TYPES.WorkSpaceCommand)
  .to(WorkSpaceCommand)
  .inSingletonScope();
container
  .bind<ServerCommand>(TYPES.ServerCommand)
  .to(ServerCommand)
  .inSingletonScope();
